			...
			<div class="wrapper mod-standard mod-gray">
				...
				<div class="details-banner">
					...
					<div class="details-banner--hero">
						...
						<asp:Image id="banner" runat="server" CssClass="details-banner--hero--img" />
					</div>
						...
						<a href="#" class="details-banner--info--box">
								<%--<img class="details-banner--info--box--img"
								 ...
								 srcset="./img/174-sm.jpg,
								 			./img/174.jpg 2x"
							     alt="alt">--%>
							<asp:Image id="artistImg" runat="server" CssClass="details-banner--info--box--img" />
						</a>
							...
							<main class="discovery--section">
								...
								<section class="standard--holder">
									...
									<div class="artist-details--biography biography">
										...
										<p></p>--%>
										<asp:Label id="bio" runat="server" CssClass=""></asp:Label>
										<a href="#">Read More...</a>
									</div>
